...
namespace MyProject.DAL.Migrations
{
    ...
    [Migration("20230216131221_migr_3")]
            ...
            modelBuilder.Entity("MyProject.BL.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CommentId = 1,
                            Author = "Neo",
                            Content = "this is some very good news!",
                            PostId = 3,
                            Title = "finally!"
                        });
                });
            ...
            modelBuilder.Entity("MyProject.BL.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublishedDateTime = new DateTime(2023, 2, 16, 14, 12, 21, 90, DateTimeKind.Local).AddTicks(7911),
                        ...
                        new
                        {
                            ...
                            PublishedDateTime = new DateTime(2023, 2, 16, 14, 12, 21, 90, DateTimeKind.Local).AddTicks(7923),
                        ...
                        new
                        {
                            ...
                            PublishedDateTime = new DateTime(2023, 2, 16, 14, 12, 21, 90, DateTimeKind.Local).AddTicks(7925),
